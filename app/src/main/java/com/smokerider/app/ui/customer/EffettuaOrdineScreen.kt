...
fun EffettuaOrdineScreen(
    ...
    Box(
        ...
        if (ordine.isNotEmpty()) {
            ...
            // Carrello vuoto: nessuna card in basso
        }
    }
}
...
private fun CollapsibleCart(
    ...
    Card(
        ...
        // HEADER: sempre visibile (totale + caret)
        Row(
            modifier = Modifier
                .fillMaxWidth()
        ...
        // CONTENUTO: lista + CTA, visibile solo se espanso
            ...
            Column {
                ...
                if (items.isEmpty()) {
                    ...
                    LazyColumn(
                        modifier = Modifier
                            .fillMaxWidth()
                            .heightIn(max = 320.dp), // evita che copra tutto
                        ...
                        items(items, key = { it.id }) { it ->
                            Row(
                                ...
                                Column(Modifier.weight(1f)) {
                                    ...
                                    Text("${it.priceEach} × ${it.qty} = ${it.lineTotal}",
                                        style = MaterialTheme.typography.bodyMedium,
